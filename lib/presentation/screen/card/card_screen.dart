...
class CardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Flutter Cards Screen')),
      body: _CardsView(),
    );
  }
}
...
class _CardsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      // Si no ponemos este widget no podríamos pintar más cosas de las que entran en pantalla.
      child: Column(
        children: [
          ...cards.map(
            (card) =>
    ...
    return Card(
      ...
      child: Stack(
        ...
        children: [
          ...
          ), // imagen de prueba, el id se corresponde con la elevación para que se vea diferente en cada card.
